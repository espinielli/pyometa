from pyometa.builder import TreeBuilder, moduleFromGrammar
from pyometa.grammar import OMetaGrammar
from pyometa.runtime import _MaybeParseError, OMetaBase, EOFError
...
class NullOptimizerTest(OMetaTestCase):
    ...
    def compile(self, grammar):
        ...
        @param grammar: A string containing an OMeta grammar.
        """
        from pyometa.grammar import OMetaGrammar, NullOptimizer
